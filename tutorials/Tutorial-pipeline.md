...
EasyNER requires very little knowledge of Python but you probably find it easier to use if you watch our "Python for Beginners" tutorial on YouTube: https://youtu.be/yDNBdB59J1s.
