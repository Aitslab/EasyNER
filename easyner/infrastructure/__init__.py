...
This package contains core infrastructure components used across the EasyNER project,
including path management, environment settings, and other low-level utilities
